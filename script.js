...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var markers = [
    { name: 'Alexandra Canal Linear Park', lat: 1.2964539527893066, lon: 103.80558776855469 },
    { name: 'Bedok Reservoir Park', lat: 1.3385679721832275, lon: 103.934326171875 },
    { name: 'Bishan-Ang Mo Kio Park', lat: 1.3601479530334473, lon: 103.85192108154297 },
    { name: 'Bukit Batok Central Park', lat: 1.3487269878387451, lon: 103.74644470214844 },
    { name: 'Choa Chu Kang Park', lat: 1.38510000705719, lon: 103.74652099609375 },
    { name: 'City Green', lat: 1.3117669820785522, lon: 103.85588073730469 },
    { name: 'East Coast Park (Zone C)', lat: 1.2979110479354858, lon: 103.90574645996094 },
    { name: 'Fort Canning Park', lat: 1.2912720441818237, lon: 103.84851837158203 },
    { name: 'Gardens by the Bay', lat: 1.2841140031814575, lon: 103.86548614501953 },
    { name: 'Green House', lat: 1.3784600496292114, lon: 103.76513671875 },
    { name: 'Holland Village Park', lat: 1.3117749691009521, lon: 103.79552459716797 },
    { name: 'Hougang Neighbourhood Park', lat: 1.367671012878418, lon: 103.89631652832031 },
    { name: 'Jubilee Gardening Community Park', lat: 1.3051249980926514, lon: 103.765625 },
    { name: 'Jurong Central Park', lat: 1.3394629955291748, lon: 103.7077865600586 },
    { name: 'Mount Faber Park', lat: 1.2703410387039185, lon: 103.82206726074219 },
    { name: 'My Waterway@Punggol', lat: 1.4071370363235474, lon: 103.90245056152344 },
    { name: 'Pasir Ris Park', lat: 1.3777610063552856, lon: 103.94451141357422 },
    { name: 'Singapore Botanic Gardens', lat: 1.3222529888153076, lon: 103.815185546875 },
    { name: 'Tampines Central Park', lat: 1.3538860082626343, lon: 103.93647003173828 },
  ...
  function addTreeMarkers() {
    markers.forEach(function (marker) {
      ...
      treeMarker.bindTooltip(marker.name, {
          permanent: false,
          direction: 'top',
          offset: [0, -20]
      });
